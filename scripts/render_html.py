...
def render(data: dict, output_path: str = "./index.html"):
    ...
    global_rows = (
        ...
        idx_row("TSM ADR", adr_pct, adr_css, "⚠️ 壓台積電" if adr_css=="up" else "↑ 助台積電", "https://finance.yahoo.com/quote/TSM/")
    )
    ...
    card_2330 = stock_card_fixed(s2330, "2330", "⚠️ ADR 衝擊" if adr_css=="up" else "ADR 助漲")
...
<div class="page" id="page-0">
  ...
  <div class="stats">
    <div class="stat">
      ...
      <div class="d {adr_css}">{adr_pct} {"⚠️" if adr_css=="up" else "✅"}</div>
